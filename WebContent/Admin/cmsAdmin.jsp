          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12">
                ...
                <p>Current Logo</p>
                <img
                  src="<%=request.getContextPath()+"/"+logoimg %>"
                  class="logo"
                  style="height: 50px"
                  alt="SACT"
                /><br>
...
<!-- MODALS -->
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="<%=request.getContextPath()+"/Admin/insertImage.jsp"%>" enctype="multipart/form-data">
 ...
 <div class="modal fade" tabindex="-1" role="dialog" id="logoTrainings">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form method="post" action=<%=request.getContextPath()+"/Admin/addAssess.jsp"%>>
