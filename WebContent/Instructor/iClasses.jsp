    ...
    <div style="background-color: rgb(241,250,248); width: 80%; height:100%;  padding: 30px; padding-left: 0px;">
        ...
        %>
                        <div class="card assess" style="width: 300px!important;">
                                <img src=<%=classInfo.getString("cardimg") %> class="card-img-top" alt="...">
                                <div class="card-body">
                                  <h4 class="card-title" value><%out.print(classInfo.getString("classsubject")); %></h4>
                                  <h5 class="card-text"><%out.print(classInfo.getString("classyear")); %></h5>
                                  <h5 class="card-cat"><%out.print(classInfo.getString("classsection")); %></h5>
              ...
              <form  method="post">
                  ...
                  <div class="row">
                    <div class="col">
                        ...
                        <input type=text class="form-control" id="cName" name="cName" placeholder="Ex. Circuits 1">
                    </div>
                    <div class="col">
                  ...
                  <input type=text class="form-control" id="cDesc" name="cDesc" placeholder="Ex. Contains basic circuits lessons.">
                  <br>
