...
<body>
	...
	<nav>
		<div class="nav nav-pills" id="nav-tab" role="tablist">
			...
			<a class="nav-item nav-link" id="nav-assess-tab" data-toggle="" href="assessment.jsp" role="tab"
				aria-controls="nav-assess" aria-selected="false" style="color: rgb(89, 197, 177);">Assessment</a>
	...
	<div style="display: flex;">
		...
		<img src="images/assess.jpg" style="margin-left: 60px; width: 45%">
		<div>
			<p
				style="font-size: 40px; color: rgb(70, 70, 70); margin-top: 150px; margin-left: 100px; margin-bottom: 10px; text-align: right;"
				id="fullName">
				Test your skills<br>and know your strength!
			</p>
			<p style="text-align: right;">Choose from a variety of skill
				assessment tests below.</p>
		</div>
	</div>
	<div style="background-color: rgb(241, 250, 248); width: 100%; border-radius: 10px; padding: 30px; padding-left: 0px;">
...
<!-- // 						out.print("<a href='#' class='btn btn-light proceed'>Proceed</a></div></div>"); -->
						...
						<div class="card-body">
							...
							<h5 class="card-cat"><%out.print(rs.getString(4)); %></h5>
